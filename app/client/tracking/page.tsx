...
import { MapPin, Clock, Truck, Phone, MessageSquare, Navigation, CheckCircle2, RefreshCw } from "lucide-react"
  ...
  const fetchRequests = async () => {
    try {
      ...
      if (response.transport_requests) {
        setRequests(response.transport_requests)
      }
    } catch (error) {
      ...
      <div className="grid lg:grid-cols-2 gap-6">
        {requests.length === 0 ? (
          ...
          requests.map((delivery) => {
            ...
            return (
              <Card key={delivery.slug} className="border-border bg-card">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="text-center p-3 rounded-lg bg-secondary/50">
                      ...
                      <p className="text-sm font-semibold text-foreground">
                        {new Date(delivery.preferred_pickup_date).toLocaleDateString()}
                      </p>
                    </div>
                    <div className="text-center p-3 rounded-lg bg-secondary/50">
                    ...
                    <div className="text-center p-3 rounded-lg bg-secondary/50">
                      ...
                      <p className="text-sm font-semibold text-foreground truncate">{delivery.pickup_city}</p>
                    </div>
                  </div>
